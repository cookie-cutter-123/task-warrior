...
def add_task(description, *args):
    ...
    """
    return subprocess.run(['task', 'add', description, *args], capture_output=True, text=True)
...
def modify_task(task_id, *args):
    ...
    """
    return subprocess.run(['task', str(task_id), 'modify', *args], capture_output=True, text=True)
...
def start_task(task_id):
    ...
    """
    return subprocess.run(['task', str(task_id), 'start'], capture_output=True, text=True)
...
def stop_task(task_id):
    ...
    """
    return subprocess.run(['task', str(task_id), 'stop'], capture_output=True, text=True)
...
def annotate_task(task_id, note):
    ...
    """
    return subprocess.run(['task', str(task_id), 'annotate', note], capture_output=True, text=True)
...
def get_task_info(task_id):
    ...
    """
    return subprocess.run(['task', str(task_id), 'info'], capture_output=True, text=True)
